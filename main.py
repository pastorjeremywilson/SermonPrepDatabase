...
the Sermon Prep Database program (v.5.1.4.001)
...
class Main:
    ...
    def get_system_info(self):
        ...
        try:
            ...
            self.write_to_log('application version is v.5.1.4.001')
    ...
    def check_for_db(self):
        ...
        if not exists(self.db_loc):
            response = QMessageBox.question(
                None,
                'Database Not Found',
                'It looks like this is the first time you\'ve run Sermon Prep Database v.5.1.4.001.\n'
