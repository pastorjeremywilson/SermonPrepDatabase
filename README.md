...
# What's New in v.5.2.0?</h2>
- Improved print dialog with a preview of what's being printed
- Improvements to some of the GUI elements
...
- <strong>Linux: </strong>Download the current SPD package file (sermon-prep-database.5.2.0.deb).
Double-click to install through your desktop's package manager or, from the command line, navigate to the file's 
directory and run the command, "sudo dpkg -i sermon-prep-database.5.2.0.deb".
